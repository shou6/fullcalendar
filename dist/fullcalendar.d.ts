...
declare module 'fullcalendar/src/util/dom-manip' {
	...
	export function elementClosest(el: HTMLElement, selector: string): any;
	export function elementMatches(el: HTMLElement, selector: string): any;
...
declare module 'fullcalendar/src/util/dom-event' {
	export function isPrimaryMouseButton(ev: MouseEvent): boolean;
	export function getEvX(ev: UIEvent): number;
	export function getEvY(ev: any): number;
...
declare module 'fullcalendar/Toolbar' {
	export class Default {
	    ...
	    render(): void;
	    removeElement(): void;
	    renderSection(position: any): HTMLElement;
...
declare module 'fullcalendar/Model' {
	...
	export class Default extends Class {
	    ...
	    watch(name: any, depList: any, startFunc: any, stopFunc?: any, isAsync?: boolean): void;
...
declare module 'fullcalendar/src/util/date' {
	import * as moment from 'moment';
...
declare module 'fullcalendar/EventSource' {
	...
	export class Default extends Class {
	    ...
	    static normalizeId(id: any): string;
	    fetch(start: any, end: any, timezone: any, onSuccess: any, onFailure: any): void;
...
declare module 'fullcalendar/EventPeriod' {
	...
	export class Default {
	    ...
	    tryRelease(): void;
	    release(): void;
	    whenReleased(callback: any): void;
	    freeze(): void;
	    thaw(): void;
	}
	export default Default;
...
declare module 'fullcalendar/EventManager' {
	import EventPeriod from 'fullcalendar/EventPeriod';
	...
	export class Default {
	    ...
	    otherSources: any;
	    constructor(calendar: any);
	    requestEvents(start: any, end: any, timezone: any, force: any, callback: any): void;
...
declare module 'fullcalendar/Calendar' {
	...
	export class Default {
	    ...
	    requestEvents(start: moment.Moment, end: moment.Moment, callback: any): void;
...
declare module 'fullcalendar/DateComponent' {
	...
	export abstract class Default extends Component {
	    ...
	    renderDrag(eventFootprints: any, seg?: any, isTouch?: boolean): boolean;
	    unrenderDrag(): void;
	    handlExternalDragStart(ev: any, el: any, skipBinding: any): void;
	    handleExternalDragMove(ev: any): void;
	    handleExternalDragStop(ev: any): void;
	    ...
	    getHitEl(hit: any): HTMLElement | null;
	    eventRangesToEventFootprints(eventRanges: any): any[];
	    eventRangeToEventFootprints(eventRange: any): EventFootprint[];
...
declare module 'fullcalendar/InteractiveDateComponent' {
	...
	export abstract class Default extends DateComponent {
	    ...
	    bindSegHoverHandlersToEl(el: any, onMouseEnter: any, onMouseLeave: any): void;
	    makeSegMouseHandler(handler: any): (ev: any, segEl: any) => any;
	    ...
	    canStartResize(seg: any, ev: any): any;
...
declare module 'fullcalendar/View' {
	...
	export abstract class Default extends InteractiveDateComponent {
	    ...
	    unsetDate(): void;
	    fetchInitialEvents(dateProfile: any, callback: any): void;
	    ...
	    reportExternalDrop(singleEventDef: any, isEvent: any, isSticky: any, el: any, ev: any): void;
	    triggerExternalDrop(singleEventDef: any, isEvent: any, el: any, ev: any): void;
...
declare module 'fullcalendar/CoordCache' {
	...
	export class Default {
	    els: HTMLElement[];
	    forcedOffsetParentEl: HTMLElement;
	    origin: any;
	    boundingRect: any;
	    isHorizontal: boolean;
	    isVertical: boolean;
...
declare module 'fullcalendar/FillRenderer' {
	export class Default {
	    ...
	    reportEls(type: any, els: any): void;
	}
	export default Default;
}
declare module 'fullcalendar/HelperRenderer' {
	...
	export abstract class Default {
	    ...
	    renderEventFootprints(eventFootprints: any, sourceSeg?: any, extraClassName?: any, opacity?: any): void;
	    abstract renderSegs(segs: any, sourceSeg?: any): HTMLElement[];
	    unrender(): void;
...
declare module 'fullcalendar/HitDragListener' {
	import { default as DragListener, DragListenerOptions } from 'fullcalendar/DragListener';
	...
	export class Default extends DragListener {
	    ...
	    hit: any;
	    coordAdjust: any;
	    constructor(component: any, options: HitDragListenerOptions);
	    handleInteractionStart(ev: any): void;
	    handleDragStart(ev: any): void;
	    handleDrag(dx: any, dy: any, ev: any): void;
	    handleDragEnd(ev: any): void;
...
declare module 'fullcalendar/ExternalDropping' {
	...
	export class Default extends Interaction {
	    ...
	    dragListener: any;
	    isDragging: boolean;
	    static getDraggedElMeta(el: any): {
	        eventProps: any;
	        startTime: any;
	        duration: any;
	        stick: any;
	    };
	    static getEmbeddedElData(el: any, name: any, shouldParseJson?: boolean): any;
	    end(): void;
	    handleDragStart(ev: any, el: any, skipBinding: any): void;
	    handleDragMove(ev: any): void;
	    handleDragStop(ev: any): void;
	    listenToExternalDrag(ev: any, el: any, skipBinding: any): void;
...
declare module 'fullcalendar/Popover' {
	import { ElementContent } from 'fullcalendar/src/util/dom-manip';
	import { ListenerInterface } from 'fullcalendar/ListenerMixin';
...
declare module 'fullcalendar/DayGridFillRenderer' {
	...
	export class Default extends FillRenderer {
	    ...
	    fillSegTag: string;
	    attachSegEls(type: any, segs: any): any[];
	    renderFillRow(type: any, seg: any): HTMLElement;
	}
	export default Default;
}
declare module 'fullcalendar/DayGrid' {
	...
	export class Default extends InteractiveDateComponent {
	    ...
	    renderSegPopoverContent(row: any, col: any, segs: any): ElementContent;
...
declare module 'fullcalendar/AgendaView' {
	import Scroller from 'fullcalendar/Scroller';
	import View from 'fullcalendar/View';
...
declare module 'fullcalendar/src/exports' {
	...
	export { applyAll, debounce, isInt, capitaliseFirstLetter, parseFieldSpecs, compareByFieldSpecs, compareByFieldSpec, flexibleCompare, log, warn } from 'fullcalendar/src/util/misc';
	...
	export { computeGreatestUnit, divideRangeByDuration, divideDurationByDuration, multiplyDuration, durationHasTime } from 'fullcalendar/src/util/date';
...
declare module 'fullcalendar/plugins/dragula/main' {
	 function constructDragula(...args: any[]): any;
...
declare module 'fullcalendar/plugins/jquery-ui-draggable/main' {
	export {};
}
