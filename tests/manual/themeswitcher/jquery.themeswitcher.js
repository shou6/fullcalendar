  ...
  $.fn.themeswitcher = function (options) {
      ...
      .bind({
        ...
        mouseleave: function () {
          if (!switcherDiv.find(".jquery-ui-switcher-list-hldr").is(":visible")) {
            $(this).css({
              "background": "#eee url(" + settings.imgpath +
    ...
    $.each(themes, function (k, v) {
      ...
      var listLink = $("<a>")
        ...
        .bind({
          mouseenter: function () {
            listLink.css("background", "url(" + settings.imgpath +
    ...
    function findTheme(theme) {
      var result = null;
      $.each(themes, function (k, v) {
        if (v.name.toLowerCase() === theme.toLowerCase() || v.title.toLowerCase() === theme
          .toLowerCase()) {
          result = v;
          return false;
        }
